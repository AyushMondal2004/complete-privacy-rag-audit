"""
Combine results/<config>_summary.csv for every config you've run into
one comparison table — this is the table your Results chapter (Chapter 4)
should be built from, using your own actual run output.
