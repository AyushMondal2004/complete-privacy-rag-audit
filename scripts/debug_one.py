"""
Diagnostic: run the pipeline on ONE policy and print everything —
retrieved evidence, raw LLM output, parsed predicted labels, and
ground-truth labels — so we can see exactly where predicted vs
expected labels diverge.
